...
import { errorArgumentos } from '../utils/HeroesErrores.js';
...
router.post('/',(req,res)=>{
    ...
    if(!name){
        ...
        CustomError.createError("Error Alta Heroes", "name es requerido", errorArgumentos(req.body), TIPOS_ERROR.ARGUMENTOS_INVALIDOS)
    }
