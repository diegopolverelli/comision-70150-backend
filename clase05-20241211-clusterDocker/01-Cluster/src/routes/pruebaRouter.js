...
router.get('/op1',(req,res)=>{
    ...
    console.log(valor1, valor2, resultado, `Resuelto por pid: ${process.pid} | instancia ${cluster.worker.id}`)
...
router.get('/op2',(req,res)=>{
    ...
    console.log(contador, resultado, `Resuelto por pid: ${process.pid} | instancia ${cluster.worker.id}`)
    console.timeEnd("Demora operación:")
